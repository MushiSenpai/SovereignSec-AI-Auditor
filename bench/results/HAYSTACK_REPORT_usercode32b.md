...
Label: **usercode32b**. Task: localize the vuln in a full file (~11 functions each, 9 files; 3×CWE-78, 3×CWE-79, 3×CWE-89). Auditor = 32B; LLM-judge scores localization vs ground truth.
